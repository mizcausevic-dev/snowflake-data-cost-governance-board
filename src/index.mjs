...
const PRODUCT = {
  "repo": "snowflake-data-cost-governance-board",
  "vendor": "Snowflake",
  "title": "data cost governance board",
  "domain": "Data Engineering",
  "audience": "Data platform leaders, analytics engineering, FinOps, and finance operators",
  "problem": "Warehouse cost and trust degrade when credit burn, query ownership, sharing contracts, and model lineage are separated.",
  "workflow": "The product links warehouse spend, query variance, data sharing, lineage risk, and remediation ownership in one board-ready view.",
  "business": "Leaders can identify waste, protect trusted data products, and decide which workloads deserve optimization investment.",
  "technical": "Synthetic warehouse lanes are scored by a Node CLI and rendered as a static governance surface.",
  "integration": "Snowflake query history, credits, warehouses, shares, tags, dbt models, and owner metadata.",
  "keywords": [
    "Snowflake",
    "warehouse cost",
    "data governance",
